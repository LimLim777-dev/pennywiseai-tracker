...
class SubscriptionRepository @Inject constructor(
    ...
    /**
     * Subscriptions due on or before [date] that the phantom auto-creator
     * materialises: all INCOME rows (#371) + opted-in EXPENSE auto-debits.
     */
    suspend fun getDueAutoGeneratedSubscriptions(date: LocalDate = LocalDate.now()): List<SubscriptionEntity> =
        subscriptionDao.getDueAutoGeneratedSubscriptions(date)
